import { Box, Group, Stack, Button, Divider, Flex, Card, Center, Typography } from "@mantine/core";
        ...
        <Group align="center" gap={"xl"} justify="center">
          <Card p={0} radius={"lg"} shadow="lg">
            <Flex className={classes.avatarContainer}>
              ...
              <ReactErrorBoundary label="Hero lanyard failed to render">
                <Flex
                  flex={1}
                  className={classes.lanyard + (modelLoaded ? " " + classes.loaded : "")}
                >
                  <Lanyard
                    position={[0, 0, 12]}
                    gravity={[0, -40, 0]}
          ...
          <Stack gap="xl">
            ...
            <Group align="center" justify="center">
              {/* <Button>订阅更新</Button> */}
              <Button onClick={(_) => (location.href = "#socials")}>
...
function HeroContent({ title, description }: { title?: ReactNode; description?: ReactNode }) {
  return (
    <Stack gap="md" p="md">
