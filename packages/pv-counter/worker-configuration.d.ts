/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: db37c000909d4a30e2f6bfbfa0b59359)
// Runtime types generated with workerd@1.20250813.0 2025-08-16 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VISIT_COUNT: KVNamespace;
		GOAT_COUNTER_HOST: string;
		GOAT_COUNTER_TOKEN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOAT_COUNTER_HOST" | "GOAT_COUNTER_TOKEN">> {}
}
